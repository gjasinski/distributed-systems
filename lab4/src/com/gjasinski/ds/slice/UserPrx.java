...
{
    default double checkAccountStatus(String id)
        throws AccessDenied
    {
        return checkAccountStatus(id, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default double checkAccountStatus(String id, java.util.Map<String, String> context)
        throws AccessDenied
    {
        try
        {
            return _iceI_checkAccountStatusAsync(id, context, true).waitForResponseOrUserEx();
        }
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Double> checkAccountStatusAsync(String id)
    {
        return _iceI_checkAccountStatusAsync(id, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Double> checkAccountStatusAsync(String id, java.util.Map<String, String> context)
    {
        return _iceI_checkAccountStatusAsync(id, context, false);
    }

    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Double> _iceI_checkAccountStatusAsync(String iceP_id, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Double> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "checkAccountStatus", null, sync, _iceE_checkAccountStatus);
    ...
    static final Class<?>[] _iceE_checkAccountStatus =
    {
        AccessDenied.class
    };

    default LoanInfo getLoanInfo(CurrencyType currencyType, double loanValue)
        throws OperationNotPermitted
    {
        return getLoanInfo(currencyType, loanValue, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default LoanInfo getLoanInfo(CurrencyType currencyType, double loanValue, java.util.Map<String, String> context)
        throws OperationNotPermitted
    {
        try
        {
            return _iceI_getLoanInfoAsync(currencyType, loanValue, context, true).waitForResponseOrUserEx();
        }
        catch(OperationNotPermitted ex)
        {
            throw ex;
        }
        catch(com.zeroc.Ice.UserException ex)
    ...
    default java.util.concurrent.CompletableFuture<LoanInfo> getLoanInfoAsync(CurrencyType currencyType, double loanValue)
    {
        return _iceI_getLoanInfoAsync(currencyType, loanValue, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<LoanInfo> getLoanInfoAsync(CurrencyType currencyType, double loanValue, java.util.Map<String, String> context)
    {
        return _iceI_getLoanInfoAsync(currencyType, loanValue, context, false);
    }

    default com.zeroc.IceInternal.OutgoingAsync<LoanInfo> _iceI_getLoanInfoAsync(CurrencyType iceP_currencyType, double iceP_loanValue, java.util.Map<String, String> context, boolean sync)
    {
        ...
        f.invoke(true, context, null, ostr -> {
                     CurrencyType.ice_write(ostr, iceP_currencyType);
                     ostr.writeDouble(iceP_loanValue);
                 }, istr -> {
                     LoanInfo ret;
